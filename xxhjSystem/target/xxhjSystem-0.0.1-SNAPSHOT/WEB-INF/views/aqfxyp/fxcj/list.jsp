...
<%
	String lx = request.getAttribute("lx").toString();
	String id = request.getAttribute("id").toString();
	request.setAttribute("datatj", "?lx="+lx+"&cid="+id+"");
%>
...
<div style="height: 100%; margin: 0px 10px;">
	...
	<cui:grid id="gridId_fxcj" rownumbers="true" multiselect="true" width="auto" fitStyle="fill" 
		url="${ctx}/aqfxyp/fxcj/searchData${datatj }" rowNum="15">
		<cui:gridCols>
...
var commbobox_sfyx=[{'value':'1','text':'有效'},{'value':'0','text':'无效'}];
	...
	function openDailog(event, ui) {
		...
		var url;
		if(ui.id == "btnId_add") {
			url = "${ctx}/aqfxyp/fxcj/toEdit?lx="+lx+"&cid="+cid;
