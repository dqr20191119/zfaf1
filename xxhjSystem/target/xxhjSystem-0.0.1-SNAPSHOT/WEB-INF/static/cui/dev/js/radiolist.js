...
$.component("coral.radiolist", $.coral.formelement,{
	...
	_initComponent: function(){
    	...
    	typeof this.element.attr("id") == "undefined" && !!this.options.id&&this.element.attr( "id", this.options.id );
	...
	_loadData : function (data) {
		...
		this._trigger("onLoad", null, [{data: data}]);
	},
	...
	_renderItem : function (cellData) {
		...
		uiLabel.append(uiIcon).append("<span class='coral-radio-text'>"+text+"</span>");
