package com.cesgroup.prison.zfxx.zfjzzy.entity;
...
@Entity
@Table(name = "ZFINFO.T_ZF_JZZY_WC")
public class ZfJzzy extends StringIDEntity {
	...
	public String toString() {
		return "ZfJzzy [cId=" + cId + ", cZfbh=" + cZfbh + ", cYymc=" + cYymc + ", cJzlb=" + cJzlb + ", cJzzysj="
				+ cJzzysj + ", dJsrq=" + dJsrq + ", cZrgjXm=" + cZrgjXm + ", dUrlTime=" + dUrlTime + ", dCjrq=" + dCjrq
				+ ", cCjpc=" + cCjpc + "]";
	}
