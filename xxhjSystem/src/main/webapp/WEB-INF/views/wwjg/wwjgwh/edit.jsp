...
<div>
	<cui:form id="formId_wwjgwh_edit">
		...
		<cui:input name="scflg" value="1" type="hidden"/>
 		...
 		<table class="table">
			...
			<tr>	
				<th>评分：</th>
				<td>
				<cui:input  name="pf" required="true"  width="250"/>
			    </td>
			</tr>
			<tr>
         	<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注：</th>
...
<script>
	...
	$.parseDone(function() {
 		...
 		var id='${id}';
		if(id) {
			loadForm("formId_wwjgwh_edit", "${ctx}/wwjg/wwjgwh/getById?id=" + id, function(data) {
	...
	function getCodes(){
		var code = $("#code").textbox("getValue");
		 $.ajax({
				type: 'post',
				url: '${ctx}/wwjg/wwjgwh/getByCode?code='+code,
				dataType: 'json',
