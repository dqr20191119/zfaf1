...
%>
<img
	src="${ctx}/static/bj-cui/img/command/logo_zhihui_${orgcodeLogo }.png"
	alt="指挥中心logo" class="logo" style="margin-left: 10px;">
<div class="header-content">
	<div class="header-item">
		<span class="icon iconfont icon-police2"></span> <span class="title"
			id="dqyh" style="line-height: 1.5;">当前用户：</span>
	</div>
	<%--
...
<ul class="tolist home" style="float: none;">
	<%-- <sec:authorize url="/zhdd/zy/zhaf/znafpt/sy"> --%>
		<li class="tolist-item status home-page" onClick="toZhsy();" style=" margin-left: 50%; font-size: 23px;">返回</li>
	<%-- </sec:authorize> --%>

	<!-- [信息汇聚_菜单] start -->
	<%-- <sec:authorize url="/zhdd/sy/afzhddpt/xxhj">
	<li class="tolist-item status">信息汇聚
		<ul class="tolist-menu">
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj">
			...
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/mjxxtj">
				<li class="tolist-menuitem" onclick="toPoliceList2()">民警信息统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/zfxxtj">
				<li class="tolist-menuitem" onclick="toPrisonerList()">罪犯信息统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/jqtj">
				<li class="tolist-menuitem"
					onClick="openMenuDialog(this, event,'alarmRecord')">警情统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/dwzttj">
							<li class="tolist-menuitem">
								电网状态统计
							</li>
							</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/swdbtj">
				<li class="tolist-menuitem"
					onClick="openMenuDialog(this, event, 'swdbgd')">事物督办统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/sbtj">
							<li class="tolist-menuitem">
								设备统计
							</li>
							</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/wlcltj">
				<li class="tolist-menuitem" onclick="toForeignCarList1()">
					外来车俩统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/wlrytj">
				<li class="tolist-menuitem"
					onClick="openMenuDialog(this, event,'wlry')">外来人员统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/xwzctj">
				<li class="tolist-menuitem"
					onClick="openMenuDialog(this, event,'xwzc1')">行为侦测统计</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/ffsjtj">
							<li class="tolist-menuitem" onclick="openFfsjtj()">
								非法手机统计
							</li>
							</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/ldgzfftj">
							<li class="tolist-menuitem">
								劳动工具发放统计
							</li>
							</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/mgctj">
							<li class="tolist-menuitem">
								敏感词统计
							</li>
							</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/mjkgtj">
				<li class="tolist-menuitem"
					onclick="openMenuDialog(this,event,'mjkgjl')">门禁开关记录</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/mjjcjl">
				<li class="tolist-menuitem"
					onclick="openMenuDialog(this,event,'mjkgjl')">民警进出记录</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/rlsbjl">
				<li class="tolist-menuitem"
					onclick="openMenuDialog(this,event,'rlsb')">人脸识别记录</li>
			</sec:authorize>
			
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/mjxcjl">
				<li class="tolist-menuitem"
					onclick="openMenuDialog(this,event,'mjxcjl')">民警巡查记录</li>
			</sec:authorize>
			
			<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/mjkqjl">
				<li class="tolist-menuitem"
					onclick="openMenuDialog(this,event,'mjkq')">民警考勤记录</li>
			</sec:authorize>
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/qjjcjl">
							<li class="tolist-menuitem"  onclick="openMenuDialog(this,event,'qjjcjl')">
								清监检查记录
							</li>
							</sec:authorize>
							<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/xqdjjl">
							<li class="tolist-menuitem"  onclick="openMenuDialog(this,event,'xqdjlb')">
								心情登记记录
							</li>
							</sec:authorize>
							 <sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/ysjgfx">
							<li class="tolist-menuitem"  onclick="openPoliceYsjgfx()">
								饮食结构分析
							</li>
							</sec:authorize> 
							
							<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/wxxpg">
			...
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/zfdm">
				<li class="tolist-menuitem">罪犯点名
					<ul>
						<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/zfdm/xsdm">
							<li class="tolist-menuitem"
								onclick="openMenuDialog(this, event,'zfxsdm')">巡视点名</li>
						</sec:authorize>
						<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/zntj/zfdm/zwdm">
							<li class="tolist-menuitem"
								onclick="openMenuDialog(this, event,'zfzwdm')">早晚点名</li>
						</sec:authorize>
					</ul>
				</li>
			</sec:authorize>
			
			 <sec:authorize url="/zhdd/sy/afzhddpt/xxhj/zfdm">
				<li class="tolist-menuitem">罪犯点名
					<ul>
						<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/zfdm/dmtj">
							<li class="tolist-menuitem"
								onclick="openMenuDialog(this, event,'zfxsdm')">点名统计</li>
						</sec:authorize>
						<sec:authorize url="/zhdd/sy/afzhddpt/xxhj/zfdm/dmxq">
							<li class="tolist-menuitem"
								onclick="openMenuDialog(this, event,'zfdmDetails')">点名详情</li>
						</sec:authorize>
					</ul>
				</li>
			</sec:authorize>
			
			已经迁移到首界面去了，这里的值排班注释掉 heqh 
			<li class="tolist-menuitem">值排班
				<ul>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'lbgl')">类别管理</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'gwgl')">岗位管理</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'bcgl')">班次管理</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'mbsz')">模板设置</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'zbbp')">值班编排</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'zbcx')">值班查询</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'zbfx')">值班分析</li>
					<!-- <li class="tolist-menuitem">
								值班导入
							</li> -->
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'zbfx')">值班日志</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this, event, 'zbfx')">交接班</li>
				</ul>
			</li>
			
			 
			<sec:authorize url="/zhdd/zy/zhaf/znafpt/xxhj/jdjc">
	...
	<!-- [信息汇聚_菜单] end -->
	<sec:authorize url="/zhdd/sy/afzhddpt/afzh">
	<li class="tolist-item status" onclick="openOldZnafpt()">安防指挥</li>
	</sec:authorize>


	<!-- [网格化管理_菜单] start -->
	<sec:authorize url="/zhdd/sy/afzhddpt/zqgl">
	<li class="tolist-item status">执勤管理
		<ul class="tolist-menu">
	
			<sec:authorize url="/zhdd/sy/afzhddpt/zqgl/yrzq">
			<li class="tolist-menuitem">一日执勤
				<ul>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this,event,'jhrc')">计划日程</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this,event,'zqgl')">执勤管理</li>
					<li class="tolist-menuitem"
						onclick="openMenuDialog(this,event,'jndtcx')">监内动态查询</li>
				</ul>
			</li>
			</sec:authorize>
			...
			<sec:authorize url="/zhdd/sy/afzhddpt/zqgl/sjjb">
	...
	<!-- [数据分析_菜单] start -->
	<sec:authorize url="/zhdd/sy/afzhddpt/sjfx">
		<li class="tolist-item status">数据分析
			<ul class="tolist-menu">
				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/jyaqfxyp">
				...
				<!-- 
					...
					<li class="tolist-menuitem" onclick="yswzfxzf()">
					 ...
					 -->
				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/mjlzqkpg">
					<li class="tolist-menuitem">民警履职情况评估
						<ul>
							...
							<sec:authorize url="/zhdd/zy/zhaf/znafpt/sjfx/mjlzqkpg/mjlzpkpg">
								<li class="tolist-menuitem" onclick="ryglfxfx()">民警履职情况评估</li>
							</sec:authorize>
						</ul>
					</li>
				</sec:authorize>

				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/mjzfsxxpg">
					<li class="tolist-menuitem">民警执法实效性评估
						<ul>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/sjldywcsgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','省局领导、业务处室关注点指标维护','shi.jv.ling.dao')">
									省局领导、业务处室关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/jqyrzbgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','监区一日值班关注点指标维护','jian.qu.yi.ri.zhi.ban')">
									监区一日值班关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/zhzxgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','指挥中心关注点指标维护','zhi.hui.zhong.xin')">
									指挥中心关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/yzglgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','狱政管理关注点指标维护','yu.zheng.guan.li')">
									狱政管理关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/xfzxgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','刑罚执行关注点指标维护','xing.fa.zhi.xing')">
									刑罚执行关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/jygzgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','教育改造关注点指标维护','jian.yu.gai.zao')">
									教育改造关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/ldgzgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','劳动改造关注点指标维护','lao.dong.gai.zao')">
									劳动改造关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/hqbzgzdwh">
								<li class="tolist-menuitem"
									onclick="openFxpgDialogSy(event,'fxdgl','后勤保障关注点指标维护','hou.qin.bao.zhang')">
									后勤保障关注点指标维护</li>
							</sec:authorize>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/mjzfsxxpg/mjzfsxxpg">
				...
				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/sbssyxwkp">
					<li class="tolist-menuitem">设备设施运行情况评估
						<ul>
							...
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/sbssyxqkpg/sbssyxqkpg">
				...
				<!-- 
					...
					<li class="tolist-menuitem" onclick="yswzfx()">
					 ...
					 -->
				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/yqjqyp">
					<li class="tolist-menuitem">狱情警情研判
						<ul>
				...
				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/yatytsgl">
					<li class="tolist-menuitem"
						onclick="openFxpgDialogSy(event,'fxgkgl','预案推送统一管理 ','')">
						预案推送统一管理</li>
				</sec:authorize>

				<sec:authorize url="/zhdd/sy/afzhddpt/sjfx/zfgzzlpg">
					<li class="tolist-menuitem">罪犯改造质量评估
						<ul>
							<sec:authorize
								url="/zhdd/zy/zhaf/znafpt/sjfx/zfgzzlpg/zfgzzlpgwh">
								<li class="tolist-menuitem"
...
//安全立体防控
 ...
 /**
  *新加入的方法，老的注释掉了。 数据来自今日动态-界面体现在登录安防平台，点击智能防控后的首页
  */
  function loadJryfqk(){
  	$.ajax({
  		type : "post",
          url : "${ctx}/xxhj/zfjbxx/jrdt",
  		dataType : "json",
  		success : function(data) {
  			debugger;
  			var cuts=data.counts.split(",");
 			for(var i=0;i<cuts.length;i++){
 				var v_i = i*1+1;
 				if($("#today"+ v_i+"_modify") != null) {
 					if(v_i == 1 || v_i == 9 || v_i == 10 || v_i == 37) {
 	 					$("#today"+v_i+"_modify").html("<p  style=\"cursor: pointer;color:red;text-align:center;font-size:22px;font-weight:bold;font-style:normal;font-family:\"Microsoft Yahei\",Arial;\"  onclick=\"searchListJryf1('"+ v_i +"')\">"+cuts[i]+"</p>");
 					} else {
 						$("#today"+v_i+"_modify").html("<p  style=\"color:red;text-align:center;font-size:22px;font-weight:bold;font-style:normal;font-family:\"Microsoft Yahei\",Arial;\">" +cuts[i] + "</p>");
 					}
 				}
 			}
  		},
 ...
 */
 ...
 //怕影响以前的代码，所以加入了一个新的，20190922 heqh
 function searchListJryf1( type){
 	$("#dialog").dialog({
 		width : 1000, //属性
 		height : 800, //属性
 		title : "罪犯信息",
 		modal : true, //属性
 		autoOpen : false,
 		url : "${ctx}/jyshouye/jryfqk/toIndex?type=" + type 
 	});
 	$("#dialog").dialog("open");
 }
 ...
 */
 function showPoliceCountZaiCe( ){
	 	$("#dialog").dialog({
	 		...
	 		modal : true, //属性
	 		autoOpen : false,
	 		url : "${ctx}/jyshouye/jryfqk/toIndexPoliceZaiCe"
	 	});
	 	$("#dialog").dialog("open");
	 }
  ...
  * 显示在监数据
  */
  function showPoliceCountInPrison ( ){
 	 	$("#dialog").dialog({
 	 		width : 1000, //属性
 	 		height : 800, //属性
 	 		title : "警察信息",
 	 		modal : true, //属性
 	 		autoOpen : false,
 	 		url : "${ctx}/jyshouye/jryfqk/toIndexPoliceInPrison"
 	 	});
 	 	$("#dialog").dialog("open");
 	 } 
