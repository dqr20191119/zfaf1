...
@Table(name = "cds_door_record_dtls_h")
public class DoorCardHisEntity extends StringIDEntity {
	...
	public String getDrdRecordId() {
		return drdRecordId;
	}
	public void setDrdRecordId(String drdRecordId) {
		this.drdRecordId = drdRecordId;
	}
	...
	public String getDrdAddrs() {
		return drdAddrs;
	}
	public void setDrdAddrs(String drdAddrs) {
		this.drdAddrs = drdAddrs;
	}
