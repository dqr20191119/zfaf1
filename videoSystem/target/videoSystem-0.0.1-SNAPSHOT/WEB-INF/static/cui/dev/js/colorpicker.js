...
$.component ( "coral.colorpicker", $.coral.inputbase, {
	...
	ids : {},
	charMin : 65,
	tp1 : '<div class="colorpicker coral-front"><div class="colorpicker_color"><div><div></div></div></div>'+
...
//		this._updateTitle();
	...
	setValue: function (value) {
		...
		if (this.options.isVisibleVal == true) {
...
/*		cal.css({
		...
		if (!that.options.isShow){
			if (this._trigger("onShow",ev,cal.get(0)) != false) {
				...
				if ( zIndexMax >= +cal.css( "z-index" ) ) {
					cal.css( "z-index", zIndexMax + 1 );
				}
				cal.show();
