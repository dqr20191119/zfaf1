    	...
    	<cui:form id="formId_rwjs_edit" heightStyle="fill">
			...
			<cui:input type='hidden' name="xfPolice" />
	 		<table class="table">
				...
				<tr>
					<th>处理结果：</th>
					<td><cui:textarea name="clContent" width="500" readonly="true"></cui:textarea></td>
				</tr>
				<tr>
					<th>处理时间：</th>
					<td><cui:datepicker id="clTime" name="clTime" width="500" readonly="true"></cui:datepicker></td>
				</tr>
			</table>
		</cui:form>
  	</div>
