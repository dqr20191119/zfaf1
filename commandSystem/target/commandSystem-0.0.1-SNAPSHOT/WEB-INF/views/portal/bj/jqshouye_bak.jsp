...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${ctx}/static/bj-cui/css/jianyu.css" />
</head>
...
<body>
  ...
  <div class="container-box jianyu">
    <div id="layout1">
      ...
      <div data-options="region:'east'" style="width:279px;">
        <div class="right">
        ...
        <div id="layout-child">
          <div data-options="region:'center'" style="overflow:hidden">
            <div class="center-wrapper">
              <div class="center-item risk">
                <div class="heading">
                  <h2 class="title">风险概况</h2>
                  <p class="more">更多+</p>
                </div>
                <div class="wrapper">
              ...
              <div class="center-item real-time">
                <div class="heading">
                  <h2 class="title">实时警情</h2>
                  <p class="more">更多+</p>
                </div>
                <ul class="wrapper alarm">
                  <li class="alarm-item">
                    <div class="list-item">
                      <img class="alarm-img" src="${ctx}/static/bj-cui/img/jianyu/emergency.png" alt="一级警情">
                    </div>
                    <p class="list-item alarm-title">一级警情</p>
                    <div class="list-item alarm-mount">
                      <p class="text emergency" id="lev_1">0</p>
                    </div>
                  </li>
                  <li class="alarm-item">
                    <div class="list-item">
                      <img class="alarm-img" src="${ctx}/static/bj-cui/img/jianyu/danger.png" alt="二级警情">
                    </div>
                    <p class="list-item alarm-title">二级警情</p>
                    <div class="list-item alarm-mount">
                      <p class="text emergency" id="lev_2">0</p>
                    </div>
                  </li>
                  <li class="alarm-item">
                    <div class="list-item">
                      <img class="alarm-img" src="${ctx}/static/bj-cui/img/jianyu/warning.png" alt="三级警情">
                    </div>
                    <p class="list-item alarm-title">三级警情</p>
                    <div class="list-item alarm-mount">
                      <p class="text warning" id="lev_3">0</p>
                    </div>
                  </li>
                  <li class="alarm-item">
                    <div class="list-item">
                      <img class="alarm-img" src="${ctx}/static/bj-cui/img/jianyu/watch.png" alt="事物督办">
                    </div>
                    <p class="list-item alarm-title">事物督办</p>
                    <div class="list-item alarm-mount">
                      <p class="text common">29</p>
                    </div>
                  </li>
                  <li class="alarm-item">
                    <div class="list-item">
                      <img class="alarm-img" src="${ctx}/static/bj-cui/img/jianyu/device.png" alt="设备故障">
                    </div>
                    <p class="list-item alarm-title">设备故障</p>
                    <div class="list-item alarm-mount">
                      <p class="text common">0</p>
                    </div>
                  </li>
                </ul>
              </div>
              <div class="center-item biology">
                <div class="heading">
                  <h2 class="title">生物识别</h2>
                  <p class="more">更多+</p>
                </div>
                <div class="wrapper">
                  <ul id="autoScrollL">
                    <li>
                      <div class="biology-item-wrapper">
                        <div class="sb-img">
          ...
          <div data-options="region:'south'" id="region-south">
            <div class="center-item meeting middle-box">
              <div class="heading ">
                <h2 class="title">今日会见</h2>
                <p class="more">更多+</p>
              </div>
              <div class="wrapper">
  ...
  <script src="${ctx}/static/bj-cui/js/jianyu.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    ...
    $('#layout1').layout({
      ...
      onCreate: function () { //回调事件: 值
        ...
        $(".duty-content").mCustomScrollbar({
          ...
          // mouseWheel: {
          // 	scrollAmount: liHeight
          // } //滚动一次的距离
        });
        $(".duty-content .yrzq").css("height", liHeight);
      }
    });
    var height = $("#layout1").layout("panel", "center").height();
    $("#region-south").height(height * 0.5);
    $('#layout-child').layout({
      fit: true, //属性: 值
      onCreate: function () { //回调事件: 值
        var height = $(".alarm .alarm-item").height();
        $(".alarm .alarm-mount").css({
          height: height,
          width: height
        })
      }
    ...
    //生物识别向上滚动的方法，每次向上滚动一条；
		moveLY = 17,moveRY = 17;
		function autoScrollL(){
			var height = $("#autoScrollL").children("li").height() - 2;
			moveLY += height;
