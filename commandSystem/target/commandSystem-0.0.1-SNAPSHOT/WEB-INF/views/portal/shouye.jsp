...
<%
	...
	String cusNumber = user.getOrgCode();
	request.setAttribute("cusNumber", cusNumber);
%>
<html>
...
<body id="warp-main">
	...
	<!-- 打开视屏窗口 -->
	<cui:dialog id="dialogId_videoPluginDemo" autoOpen="false" iframePanel="true" reLoadOnOpen="true" modal="false" resizable="false" autoDestroy="true">
		<%--<div id="demoPic" style="width: 100%; height: 100%;"></div>--%>
	</cui:dialog>
		...
		<cui:layoutRegion region="east" split="true" collapsed="false" style="width:280px;" onLoad="alarmLeave">
			<div class="wrapper">
	          ...
	          <div class="device-wrapper">
	            ...
	            <div class="device-nav" id="sbtj_div">
	            </div>
...
<script>
	...
	/**
	 * 定时加载询技防设备数量总信息 每两分钟刷新一次
	 */
	 var intervaQueryTechnicalDeviceCount=setInterval(function(){
		 queryTechnicalDeviceCount();
	},120000);
    ...
    /**
     * 监区隐藏
     * 三维巡视swxs_li  预案管理 zhxt_bjya_li  门禁控制 realTimeTalk  数字电网 powerNetwork   故障维修 zhxt_deviceRecord
     实时对讲 aqfk_realTimeTalk   融合通信 rhtx_li
     */
    function jq_hide() {
        ...
        if(user_level==3){
            ...
            $("#realTimeTalk").hide();
            $("#powerNetwork").hide();
            $("#zhxt_deviceRecord").hide();
            $("#aqfk_realTimeTalk").hide();
            $("#rhtx_li").hide();
            $("#yjdd_li").hide();
        }
    }
    //返回综合首页
    function openZnafpt_li() {
