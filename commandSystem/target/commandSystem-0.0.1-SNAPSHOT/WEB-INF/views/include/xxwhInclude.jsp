...
<%@ taglib prefix="sec" tagdir="/WEB-INF/tags/security" %>
	...
	<sec:authorize url="/zhdd/sy/xxwh/qymcwh">
    <li id="xtgl_qywh" onclick="">
	  ...
	  <sec:authorize url="/zhdd/sy/xxwh/sbglwh">
	  <li id="xtgl_jfsb">
         <a href="javascript: void(0)">
                    设备管理维护
         </a>
          <iframe class="main-iframe"></iframe>
			...
			<sec:authorize url="/zhdd/sy/xxwh/sbglwh/gbgl">
			<li>
                <a href="javascript:void(0);">广播管理</a>
                <iframe class="main-iframe"></iframe>
				<ul>
					<sec:authorize url="/zhdd/sy/xxwh/sbglwh/gbgl/gbsbwh">
					<li id="xxgl_broadcast" onclick="openXxglDialog(event,'broadcast')">
						<a href="#">广播设备维护</a>
					</li>
					</sec:authorize>
					<sec:authorize url="/zhdd/sy/xxwh/sbglwh/gbgl/gbqmwh">
	...
	<sec:authorize url="/zhdd/sy/xxwh/dztdwh">
	<li>
		<a href="javascript:void(0)">
			              电子地图维护
			     </a>
        <iframe class="main-iframe"></iframe>
		<ul>
			<sec:authorize url="/zhdd/sy/xxwh/dztdwh/swdt">
		    <li id="xtgl_swdtwh" >
                <a href="javascript:void(0)">
                    三维地图
                    <b class="leftArrow"></b>
			...
			<sec:authorize url="/zhdd/sy/xxwh/dztdwh/ewdt">
		    <li id="xtgl_ewdtwh" onclick="">
                ...
                <iframe class="sub-iframe"></iframe>
		        <ul>
				   <sec:authorize url="/zhdd/sy/xxwh/dztdwh/ewdt/tcwh">
			        <li id="xxgl_ewtcwh" onclick="openXxglDialog(event,'ewtcwh')">
			            <a href="javascript:void(0);">图层维护</a>
			        </li>
			        </sec:authorize>
				   <sec:authorize url="/zhdd/sy/xxwh/dztdwh/ewdt/dwwh">
	...
	<sec:authorize url="/zhdd/sy/xxwh/xxdygl">
    <li id="xxdy" onclick="openXxglDialog(event, 'xxdy')">
        <a href="javascript:void(0)">消息订阅管理</a>
    </li>
 	</sec:authorize>

	<!-- TODO 由于角色全部用的是工程师角色，定时任务菜单暂时注释，防止用户误操作 -->
	<sec:authorize url="/zhdd/sy/xxwh/dsrwgl">
	<li id="crontab" onclick="openXxglDialog(event,'crontab')">
        <a href="javascript:void(0)">定时任务管理</a>
    </li>
	</sec:authorize>
    <sec:authorize url="/zhdd/sy/xxwh/rzgl">
        <li id="xtgl_swdtwh" >
            <a href="javascript:void(0)">
                日志管理
            </a>
            <iframe class="main-iframe"></iframe>
            <ul>
                <sec:authorize url="/zhdd/sy/xxwh/rzgl/rzcx">
                    <li id="xxgl_mxwh" onclick="openXxglDialog(event,'rzcx')">
                        <a href="javascript:void(0);">日志查询</a>
                    </li>
                </sec:authorize>
                <sec:authorize url="/zhdd/sy/xxwh/rzgl/rztj">
                    <li id="xxgl_dwwh" onclick="openXxglDialog(event,'rztj')">
                        <a href="javascript:void(0);">日志统计</a>
                    </li>
                </sec:authorize>
                <sec:authorize url="/zhdd/sy/xxwh/rzgl/tbfx">
                    <li id="xxgl_bjtcwh" onclick="openXxglDialog(event,'rztb')">
                        <a href="javascript:void(0);">图表分析</a>
                    </li>
                </sec:authorize>
            </ul>
        </li>
	...
	<!-- 系统参数配置 -->
    <sec:authorize url="/zhdd/sy/xxwh/xtcspz">
	<li id="xxgl_xtcspz" onclick="openXxglDialog(event,'xtcspz')">
		<a href="javascript:void(0)">系统参数配置</a>
	</li>
    </sec:authorize>
<script>
    function openXxglDialog(event, name) {
        ...
        }else if (name == "xtcspz") {//系统参数配置
			url = jsConst.basePath + '/xtcs/openDialog';
		}
