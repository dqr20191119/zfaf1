...
<sec:authorize url="/zhdd/sy/zhdd/rcdd">
<li>
	...
	<ul>
		...
		<li>
			...
			<ul>
				...
				<sec:authorize url="/zhdd/sy/zhdd/rcdd/gbkz/gbbf">
				<li id="aqfk_broadcastPlay" onclick="toAqfkDisplay('broadcastPlay')">
					<a href="#">广播播放</a>
				</li>
				</sec:authorize >
				<sec:authorize url="/zhdd/sy/zhdd/rcdd/gbkz/gbbfjl">
		...
		<sec:authorize url="/zhdd/sy/zhdd/rcdd/rhtx">
		<li id="rhtx_li">
			
			<a href="javascript:void(0);">融合通信</a>
			<b class="leftArrow"></b>
			<iframe class="sub-iframe"></iframe>
			<ul>
			
				<sec:authorize url="/zhdd/sy/zhdd/rcdd/rhtx/xxfs">
				<li id="aqfk_rcs" onclick="openFxpgDialog(this,'rcs','信息发送')">
					<a href="javascript: void(0)">信息发送</a>
				</li>
				</sec:authorize >
				<sec:authorize url="/zhdd/sy/zhdd/rcdd/rhtx/txjl">
				<li id="aqfk_search" onclick="openFxpgDialog(this,'search','通信记录')">
					<a href="javascript: void(0)">通信记录</a>
				</li>
				</sec:authorize>
			</ul>
			<%-- <ul>
				<sec:authorize url="/zhdd/sy/txddxt/rhtx/xxfs">
				<li  onclick="openFxpgDialog(this,    'rcs')">信息发送</li>
				</sec:authorize>
				<sec:authorize url="/zhdd/sy/txddxt/rhtx/txjl">
				<li  onclick="openFxpgDialog(this,    'search')">通信记录</li>
				</sec:authorize>
			</ul> --%>
...
<script type="text/javascript"
	src="${ctx}/static/module/video/js/video-plugin-layout.js"></script>
<script>
