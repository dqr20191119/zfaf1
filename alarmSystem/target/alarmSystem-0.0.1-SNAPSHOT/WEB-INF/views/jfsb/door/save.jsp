	...
	<cui:form id="formId_mj_save" heightStyle="fill">
		<table class="table" style="width: 98%">
			<tr>
				<th>编号：</th>
				<td>
					<cui:input name="dcbIdnty" componentCls="form-control" required="true"></cui:input>
				</td>
				<th>所属区域：</th>
				<td>
					<cui:combotree id="combId_area" componentCls="form-control" name="dcbAreaId" url="${ctx}" simpleDataEnable="true" simpleDataIdKey="id" simpleDataPIdKey="pid" keyName="name" required="true" onNodeClick="onAreaTreeClick_sxt"></cui:combotree>
				</td>
			</tr>
			<tr>
				<th>名称：</th>
...
<script>
	$.parseDone(function() {
		$("#combId_doorCtl").combobox("reload", "${ctx}/doorControl/seachComboData.json?cusNumber=" + cusNumber);
		//部门数据请求
