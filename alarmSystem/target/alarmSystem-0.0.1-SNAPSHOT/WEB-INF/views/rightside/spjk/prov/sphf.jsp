...
<div id="cameraGroup" class="cameraGroup" style="height:96%;width:99%;">
			...
			<div class="tree-box">
				<div style="width:100%;height:100%;" class="mscroll">
					<cui:tree id="ddtsdTree" asyncEnable="true" keepParent="true"
						asyncType="post" simpleDataEnable="true"
						asyncUrl=""
						asyncAutoParam="id,name" onDblClick="" rootNode="true" 
						onClick="loadBackHandle_camera" formatter="cameraFormatter"
						showRootNode="true">
					</cui:tree>
				</div>
			</div>
...
$.parseDone(function(){
	...
	//初始化树
	$("#dddsdTree").tree("option","asyncUrl","${ctx}/provGroupManage/allPrisonAreaCameraTree.json");
	$("#ddtsdTree").tree("option","asyncUrl","${ctx}/provGroupManage/allPrisonAreaCameraTree.json");	
	$("#ddbtsdTree").tree("option","asyncUrl","${ctx}/provGroupManage/allPrisonAreaCameraTree.json");
	//加载第一个面板
