...
<div style="text-align: center; height: 100%; width: 100%">
	<cui:form id="formId_record" heightStyle="fill">
		<table class="table table-bordered" style="width: 98%">
			...
			<tr>
				<th>备注：</th>
				<td colspan="5">
					<cui:textarea id="textId_remark" name="dmaRemark" componentCls="form-control" required="true">
					</cui:textarea>
				</td>
			</tr>
		</table>
	...
	<div class="dialog-buttons" style="margin-bottom: 0px; text-align: center;">
		<cui:button   label="提醒" onClick="remind"></cui:button>
		<cui:button  label="取消" onClick="cancel"></cui:button>
	</div>
...
<script>
	...
	function remind() {
		if ($("#formId_record").form("valid")) {
			var formData = {};
			formData["id"] = "${ID}";
			formData["dmaRemindType"] ="1";
			formData["dmaRemark"] = $("#textId_remark").textbox("getText") ;;
			var ur = "${ctx}/deviceMaintain/remind.json";
			$.ajax({
				type : "post",
				url : ur,
				data : formData,
