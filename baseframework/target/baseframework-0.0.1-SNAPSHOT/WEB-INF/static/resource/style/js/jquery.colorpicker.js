...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<tr height=30><td colspan="2"1 bgcolor=#cccccc>'
            ...
            +'<table id="CT" width="253" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="000000"  style="cursor:pointer;">'
            +colorTable+'</table>';
