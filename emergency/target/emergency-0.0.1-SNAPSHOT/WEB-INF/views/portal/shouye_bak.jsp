...
<link rel="stylesheet" href="${ctx}/static/cui/jquery.mCustomScrollbar.css" />
<link rel="stylesheet" href="${ctx}/static/cui/style.css" />
<!-- coral4 css  end  -->
...
<body id="warp-main">
	...
	<cui:layout id="layout1" fit="true">
		...
		<!-- <div id="warp-main"> -->
		<cui:layoutRegion region="east" split="true" collapsed="false" style="width:325px;" onLoad="alarmLeave">
		</cui:layoutRegion>
...
<script>
	...
	function initPage(){
		...
		if(jsConst.USER_LEVEL==1){
			...
			//监区视频工具栏隐藏
			window.top.videoClient.setConfig(1,1,0);
