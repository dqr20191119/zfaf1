					...
					<sec:authorize url="/zhdd/zy">
						<div class="content">
							<ul class="system">
								...
								<sec:authorize url="/zhdd/sy/afzhddpt">
										...
										<div class="system-content ">
											<div class="system-text">
												<img class="system-img"
													...
													alt="安防指挥调度平台"><span class="title">安防指挥调度平台</span>
											</div>
										</div>
									</li>
								</sec:authorize>

								<sec:authorize url="/zhdd/sy/zpbgl">
										...
										<div class="system-content">
											<div class="system-text">
												<img class="system-img"
													...
													alt="智能安防平台"><span class="title">值排班管理</span>
											</div>
										</div>
									</li>
								</sec:authorize>
								...
								<li class="system-item" onClick="openTxddxx()" id="txddxt" >
									<div class="system-content ">
										<div class="system-text">
											<img class="system-img"
												src="${ctx}/static/bj-cui/img/icons/icon-risk.png"
												alt="通讯调度系统"><span class="title">通讯调度系统</span>
										</div>
									</div>
								</li>
								</sec:authorize>
