			...
			<tr>
				<td>
					...
					<div>
						...
						<div>外出原因：<cui:textarea name="sflReason" width="180" height="27" isLabel="true"></cui:textarea></div>
					</div>
					<div style="margin-top: 1px">
						审核：<cui:combobox id="checkStts" componentCls="form-control" data="checkStts" width="200" required="true"></cui:combobox>
						</div>
				</td>
			</tr>
		</table>
...
<script>
	...
	function submit() {
		if ($("#formId_addInfo").form("valid")) {
			...
			var id = "${ID}";
			var sflFlowCheckStts = $("#checkStts").combobox("getValue");

			if (id != "") {
				postData["id"] = id;
			}
			if (sflFlowCheckStts != "") {
				postData["sflFlowCheckStts"] = sflFlowCheckStts;
			}
