	...
	<cui:form id="formId_ylsp_edit">
		...
		<cui:input type='hidden' name="edpStatus" />	
 		<table class="table">
			...
			<tr>
				<th>演练时间：</th>
				<td><cui:datepicker name="edpTime" dateFormat="yyyy-MM-dd" readonly="true"></cui:datepicker></td>
				<th>演练地点：</th>
		...
		<table class="table">
			<tr>
				...
				<th>审批意见</th>
				<td><cui:radiolist id="radiolistId_ylsp_edit" name="ehaIsAgree" data="combobox_yjct_sfty" required="true"></cui:radiolist></td>
			</tr>
			<tr>
				<th>审批内容</th>
...
<script>
	...
	$.parseDone(function() {
		...
		var id = '${id}';
		if(id) {
			loadForm("formId_ylsp_edit", "${ctx}/yjct/yljh/getById?id=" + id, function(data) {
