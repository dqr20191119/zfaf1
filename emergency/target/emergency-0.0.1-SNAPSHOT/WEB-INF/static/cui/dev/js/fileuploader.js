...
(function () {
    ...
    $.component('coral.fileuploader', {
    	castProperties : ["triggers", "uploadBtnOptions", "formData", "downloadTmp"],    	
    	checkIE: function(){
        ...
        _getConfig: function() {
			...
			var p = {
				...
				uploadTmp : function(files) {
					var error,itemHTML,str='';
					if(files.fileError){
						error = '<div class="fileError"><span class="error"></span></div>';
					}else{
						error = "";
					}
					var strReg = /png|jpg|bmp|gif|jpeg/i;
					if(strReg.test(files.fileType) == true && files.fileThumbnailUrl){
						str = '<span class="fileThumb"> <img src= "{{fileThumbnailUrl}}"></span>';
					} else {
				...
				uploadTemplate : function(o){
					...
					itemData.fileThumbnailUrl = o.options.getObjectURL(o.files[0]);
        ...
        _setOption: function(key, value) {
    		...
    		if(this.useFlash){
    			this.uploaderBtn.swfuploader( "option", key, value);
    		}
    		if (key === "formData") {
    			if (this.useFlash) {
