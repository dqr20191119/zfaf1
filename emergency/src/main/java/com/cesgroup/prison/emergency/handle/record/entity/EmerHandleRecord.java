package com.cesgroup.prison.emergency.handle.record.entity;
...
public class EmerHandleRecord extends StringIDEntity {
    /**
     * 单位编号
     */
     ...
     */
    @Transient
    private List<EmerHandleRecordStep> handleStepList;
    /**
     * 人员登记表附件列表
     */
    @Transient
    ...
    public List<EmerHandleRecordStep> getHandleStepList() {
        return handleStepList;
    }

    public void setHandleStepList(List<EmerHandleRecordStep> handleStepList) {
