...
function initControlEvents(control) {
    ...
    if (typeof (map_3d.onKeyUp) == "function") ____events["onKeyUp"] = map_3d.onKeyUp;
    if (typeof (map_3d.onMouseClickSelect) == "function") ____events["onMouseClickSelect"] = map_3d.onMouseClickSelect;
    if (typeof (map_3d.onMouseDragSelect) == "function") ____events["onMouseDragSelect"] = map_3d.onMouseDragSelect;
    ...
    if (typeof (map_3d.onCameraFlyFinished) == "function") ____events["onCameraFlyFinished"] = map_3d.onCameraFlyFinished;
    if (typeof (map_3d.onCameraTourWaypointChanged) == "function") ____events["onCameraTourWaypointChanged"] = map_3d.onCameraTourWaypointChanged;
    ...
    if (typeof (map_3d.onObjectEditing) == "function") ____events["onObjectEditing"] = map_3d.onObjectEditing;
    ...
    if (typeof (map_3d.onCameraUndoRedoStatusChanged) == "function") ____events["onCameraUndoRedoStatusChanged"] = map_3d.onCameraUndoRedoStatusChanged;
...
mapSever = {
	//湖南雁南监狱
	"p_4303":{cepServerPath:'Package_hn_yannan_jy/hn_yannan_jy.cep',fdbServerIp:'34.211.0.208',fdbServerPort:'8040',fdbServerName:'hn_yannan_jy'},
	//湖南岳阳监狱
	"p_4312":{cepServerPath:'Package_hn_yyang_jy/hn_yyang_jy.cep',fdbServerIp:'34.211.0.208',fdbServerPort:'8040',fdbServerName:'hn_yyang_jy'},
	//湖南女子监狱
	"p_4307":{cepServerPath:'Package_hn_nvzi_jy/hn_nvzi_jy.cep',fdbServerIp:'34.211.0.208',fdbServerPort:'8040',fdbServerName:'hn_nvzi_jy'},
	//湖南怀化监狱
	"p_4336":{cepServerPath:'Package_hn_hhua_jy/hn_hhua_jy.cep',fdbServerIp:'34.211.0.208',fdbServerPort:'8040',fdbServerName:'hn_hhua_jy'},
	//湖南永州监狱
	"p_4304":{cepServerPath:'Package_hn_yzhou_jy/hn_yzhou_jy.cep',fdbServerIp:'34.211.0.208',fdbServerPort:'8040',fdbServerName:'hn_yzhou_jy'}
}

//监狱编号对应的图层路径
mapLayerPath = {
	//湖南雁南监狱
	"p_4303":"hn_yannan_jy\\HN_YNANJY_DataSet\\雁南监狱",
	//湖南岳阳监狱
	"p_4312":"hn_yyang_jy\\HN_YUEYANGJY_DataSet\\岳阳监狱",
	//湖南女子监狱
	"p_4307":"hn_nvzi_jy\\hnnzjy\\女子监狱",
	//湖南怀化监狱
	"p_4336":"hn_hhua_jy\\HN_HHUAN_JY_DataSet\\怀化监狱",
	//湖南永州监狱
	"p_4304":"hn_yzhou_jy\\HN_YONGZHOU_JY_DataSet\\永州监狱",
}

//设备模型名称和图片名称
//设备类型：1-摄像头，2-对讲分机，3-报警器，4-门禁，5-广播，6-对讲主机
mapDevice = {
    "dt_1":{"model":{'d_1':'osg/banqiuji.osg','d_2':'osg/qiangji.osg',"d_3":'osg/banqiuji.osg',"d_4":'osg/qiuji.osg'},
        "img":{"d_1":'png/banqiuji.png',"d_2":'png/qiangji.png',"d_3":'png/banqiuji.png',"d_4":'png/banqiuji.png'}},
    //摄像头类型1,半球机 2，枪机 3，模拟半球机 4、球机
    "dt_2":{"model":{'d_1':'osg/fenduijiang.osg'},'img':{'d_1':'png/fenduijiang.png'}},//分对讲
    "dt_3":{"model":{'d_1':'osg/chufabaojingqi.osg'},'img':{'d_1':'png/chufabaojingqi.png'}},//报警器
    "dt_4":{"model":{'d_1':'osg/menjin.osg'},'img':{'d_1':'png/menjin.png'}},//门禁
    "dt_5":{"model":{'d_1':'osg/guangbo.osg'},'img':{'d_1':'png/guangbo.png'}},//广播
    "dt_6":{"model":{'d_1':'osg/zhuduijiang.osg'},'img':{'d_1':'png/zhuduijiang.png'}},//主对讲
    "dt_8":{"model":{'d_8':'osg/chuagnwei.osg'},'img':{'d_8':'png/chuagnwei.png'}}//监舍点位
