...
<body>
			...
			<div class="content-wrapper menhu-subsystem">
				...
				<div class="content-slide">
					...
					<sec:authorize url="/zhdd/sy">
						<div class="content">
							<ul class="system">
								<sec:authorize url="/zhdd/sy/jrts">
                                <li class="system-item" onclick="openJrts()">
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-voice.png"
                                                 alt="今日态势"><span class="title">今日态势</span>
                                        </div>
                                    </div>
                                </li>
                                </sec:authorize>
                                
                                 <sec:authorize url="/zhdd/sy/spjk">
                                <li class="system-item" onClick="openSpjk()" id="spjk" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-video-watch.png"
                                                 alt="视频监控"><span class="title">视频监控</span>
                                        </div>
                                    </div>
                                </li>
								</sec:authorize>
                                ...
                                <sec:authorize url="/zhdd/sy/jqcz">
                                <li class="system-item" onClick="openJqcz()" id="jqcz" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-emergency.png"
                                                 alt="警情处置"><span class="title">警情处置</span>
                                        </div>
                                    </div>
                                </li>
								</sec:authorize>
                                
                                 <sec:authorize url="/zhdd/sy/swdb">
                                <li class="system-item" onClick="openMeuDialog(this, event, 'swdbgd')" id="swdb" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-cure.png"
                                                 alt="事务督办"><span class="title">事务督办</span>
                                        </div>
                                    </div>
                                </li>
								</sec:authorize>
								...
								<sec:authorize url="/zhdd/zy/zhaf/zbpb">
									<li class="system-item"
										onclick="openMenuDialog(this, event, 'zbbp')">
										<div class="system-content">
											<div class="system-text">
												<img class="system-img"
													src="${ctx}/static/bj-cui/img/icons/icon-certificate.png"
								...
								--%>
                                <%--<sec:authorize url="/zhdd/sy/txddxt">
                                    <li class="system-item" onClick="openTxddxx()" id="txddxt" >
                                        <div class="system-content ">
                                            <div class="system-text">
                                                <img class="system-img"
                                                     src="${ctx}/static/bj-cui/img/icons/icon-risk.png"
                                                     alt="通讯调度系统"><span class="title">通讯调度</span>
                                            </div>
                                        </div>
                                    </li>
                                </sec:authorize>--%>
                                <sec:authorize url="/zhdd/sy/xxhj">
                                <li class="system-item" onClick="openXxhj()" id="xxhj" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-gis.png"
                                                 alt="信息汇聚"><span class="title">信息汇聚</span>
                                        </div>
                                    </div>
                                </li>
                                </sec:authorize>

                                <sec:authorize url="/zhdd/sy/xxyp">
                                <li class="system-item" onClick="openXxyp()" id="xxyp" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-lightning.png"
                                                 alt="信息研判"><span class="title">信息研判</span>
                                        </div>
                                    </div>
                                </li>
                                </sec:authorize>
                                 <sec:authorize url="/zhdd/sy/aqfh">
                                <li class="system-item" onClick="openAqfh()" id="aqfh" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-patrol.png"
                                                 alt="安全复核"><span class="title">安全复核</span>
                                        </div>
                                    </div>
                                </li>
								</sec:authorize>
                                
                               <%-- <sec:authorize url="/zhdd/sy/rzgl">
                                <li class="system-item" onClick="openRzgl()" id="rzgl" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-watch.png"
                                                 alt="日志管理"><span class="title">日志管理</span>
                                        </div>
                                    </div>
                                </li>
                                </sec:authorize>--%>
                                <sec:authorize url="/zhdd/sy/xtjc">
                                <li class="system-item" onClick="openXtjc()" id="xtjc" >
                                    <div class="system-content ">
                                        <div class="system-text">
                                            <img class="system-img"
                                                 src="${ctx}/static/bj-cui/img/icons/icon-intranet.png"
                                                 alt="系统集成"><span class="title">系统集成</span>
                                        </div>
                                    </div>
                                </li>
								</sec:authorize>
                                <sec:authorize url="/zhdd/sy/xxwh">
                                    <li class="system-item" onClick="openXxwh()" id="xxwh" >
                                        <div class="system-content ">
                                            <div class="system-text">
                                                <img class="system-img"
                                                     src="${ctx}/static/bj-cui/img/icons/icon-identity.png"
                                                     alt="系统管理"><span class="title">系统管理</span>
                                            </div>
                                        </div>
                                    </li>
                                </sec:authorize>
								...
								<sec:authorize url="/zhdd/sy/hkspjkpt">
								 <li class="system-item" onClick="openSpjk()">
					              ...
					              <%-- 
					               <li class="system-item" onClick="openHk()">
					                <div class="system-content ">
					                  <div class="system-text">
					                  <img class="system-img" src="${ctx}/static/bj-cui/img/icons/icon-video-watch.png" alt="海康8700平台">
					                  <span class="title">海康8700平台</span>
					                      </div>
					                </div>
					              </li>--%>
											...
											<div class="system-content ">
												<div class="system-text">
													<img class="system-img"
														...
														alt="运维管理系统"><span class="title">运维管理系统</span>
												</div>
											</div>
										</li>
								 </sec:authorize> --%>
					          <%--   <li class="system-item" onClick="openErp()">
					                <div class="system-content">
					                  <div class="system-text"><img class="system-img" src="${ctx}/static/bj-cui/img/icons/icon-labour.png" alt="移动警务系统"><span
					                      class="title">ERP劳动项目管理系统</span></div>
					                </div>
					              </li> --%>
					             ...
					             <%-- <li class="system-item" onClick="openHj()">
					              ...
					              <%-- <li class="system-item"  onClick="openYwgk()">
					                <div class="system-content ">
							...
							<%-- 	<sec:authorize url="/zhdd/zy/zhaf/jyaqfxypxt">
								...
								<%-- <li class="system-item" onClick="openJydgnglxt()" id="jydgnglxt" style="display:none;">
									<div class="system-content ">
										<div class="system-text">
											<img class="system-img"
												src="${ctx}/static/bj-cui/img/icons/icon-risk.png"
												alt="监狱多功能管理系统"><span class="title">监狱多功能管理系统</span>
										</div>
									</div>
								</li> --%>
	...
	$(function() {
        ...
        var USER_LEVEL = '<%=AuthSystemFacade.whatLevelForLoginUser()%>';
        if(USER_LEVEL==3){
            load_jq_qx();
        }
	});
	...
	<script>
		...
		*/
         ...
         */
        function openXxhj() {
            var url = "${ctx}/portal/xxhj/shouye";
           // window.open(url, "_blank");
            window.location.href = url;
        }
        ...
        */
		function  openJqcz(){
			var url = "${ctx}/portal/jqcz/shouye";
			window.location.href = url;
		}
		 ...
		 */
		function openXxwh() {
			var url = "${ctx}/portal/xxwh/shouye";
			//window.open(url, "_blank");
			window.location.href = url;
		}
         ...
         */
        function openXxyp() {
            var url = "${ctx}/portal/xxyp/shouye";
           // window.open(url, "_blank");
            window.location.href = url;
        }
        /**
         ...
         */
        function openSpjk(){
        	 var url = "${ctx}/portal/spjk/shouye";
             // window.open(url, "_blank");
              window.location.href = url;
        }
        ...
        */
      function  openAqfh(){
    	  var url = "${ctx}/portal/aqfh/shouye";
          // window.open(url, "_blank");
           window.location.href = url;
      }
         ...
         */
        function openXtjc() {
            var url = "${ctx}/portal/xtjc/shouye";
            //window.open(url, "_blank");
            window.location.href = url;
        }
        /**
         ...
         */
        function openRzgl() {
            var url = "${ctx}/portal/rzgl/shouye";
            //window.open(url, "_blank");
            window.location.href = url;
        }
       ...
       function openMeuDialog(obj,event,name){
