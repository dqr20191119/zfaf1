								...
								<ul>
									...
									<li>
										...
										<div class="dutyPerson">
												...
												<p class="dutyNme"  id="policeCountInPrison111">0</p>
									...
									<li>
										...
										<div class="dutyPerson">
											...
											<a class="dutyNme" href="#"id="policeCountBeiQin" >0</a>
										</div>
									</li>
								...
								<li>
									...
									<div class="custodyPerson alertShow" id="zfWcjy">
										<p class="custodyTitle alertType">保外就医</p>
										 <p class="" style="color:red" id="today50_modify">0</p>  
									</div>
								</li>
								<li>
									<div class="info-icon custodyIcon alermIcon">
			...
			<div data-options="region:'center'" class="main">
				...
				<div class="center-box clearfix">
					<div class="center-left" style="width:349.99px;">
						...
						<h3>消息中心<span></span></h3>
						<div class="left-box" >
							<div class="top-box top-right">
								<div class="todo_List">
									<ul class="theader clearfix">
										 <li style="width:33%;">任务下发时间</li>
										<li style="width:35%;">&nbsp;&nbsp;&nbsp;任务标题</li>
										<!-- <li>事务类型</li> -->
										<li style="width:30%;">&nbsp;&nbsp;&nbsp;任务状态</li>
										<!-- <li style="width:35%;">事由</li>  -->
									</ul>
									<div class="tcontent">
										<ul id="swdb">
					...
					<div class="center-middle" style="width: 410px">
						<h3>警囚分布<span><a href="javascript: void(0);" onClick="openMenuDialog(this, event, 'swsb')">更多+</a></span></h3>
						<div class="middle-box">
							<div class="top-box top-right">
								<div class="todo_List">
									<ul class="theader clearfix">
										<li style="width:23%;">监区</li>
										<li style="width: 37%; text-align: left">在监警察/在册警察</li>
										<li style="width:20%;text-align: left">罪犯</li>
										<li style="width:20%;">警囚比</li>
					...
					<div class="center-right" style="width:480px;">
	...
	$("#dialogId_rightHomeMenu").dialog("open");
		...
		function queryPoliceCountInqjbSj(obj, deptName, deptCode){
			...
			$.ajax({
				...
				success : function(data) {
					...
					$(obj).append("/");
                    policeCountInPrison =Number(data.policeCountInPrison);
				},
				error : function(XMLHttpRequest, textStatus, errorThrown) {
					$.messageQueue({ message : textStatus, cls : "warning", iframePanel : true, type : "info" });
				}
			...
			$.ajax({
				...
				success : function(data) {
                    ...
                    criminalCount = Number(data.criminalCount);
                    if(policeCountInPrison/criminalCount <0.3){
                        $(obj).css({"color":"red"});
                        $(obj).find("a").css({"color":"red"});
                    }else{
                        $(obj).css({"color":"#00fff6"});
                        $(obj).find("a").css({"color":"#00fff6"});
                    }
				},
				error : function(XMLHttpRequest, textStatus, errorThrown) {
					$.messageQueue({ message : textStatus, cls : "warning", iframePanel : true, type : "info" });
		...
		*/
		...
		function queryPoliceCountInPrisonAreaByAreaName(obj, deptName, deptCode) {
            ...
            $.ajax({
                type : "post",
                url : "${ctx}/xxhj/jnmj/queryPrisonDrptmntPoliceInfo",
                data: {
                    para: "2",
                    cusNumber:jsConst.CUS_NUMBER,
                    drptmntId:deptCode,
