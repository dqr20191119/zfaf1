...
<cui:tabs heightStyle="fill">
	<cui:dialog id="dialog1" autoOpen="false" iframePanel="true"  reLoadOnOpen="true"  modal="true" resizable="false"></cui:dialog>
	<ul>
...
var snapType = ${type}; //表示视频截图类型 值为1
