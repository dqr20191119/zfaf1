...
<div class="F-left" style="width: 100%;height:100%;overflow-y: auto; overflow-x: hidden;border-right: 1px solid #79accc;">
	<!-- 应急预案树 -->
...
<script>
$.parseDone(function() {
	$("#treeId_preplanTree").tree("option", "asyncUrl", "${ctx}/emergency/groupManage/initTree");
...
function refreshList(nodeId) {
    ...
    panel.panel('refresh', "${ctx}/emergency/groupManage/toList?preplanId=" + nodeId);
}
...
function refreshTree() {
	$("#treeId_preplanTree").tree("reload", "${ctx}/emergency/groupManage/initTree");

	setTimeout(function () {
		var preplanId = $("#formId_group_query").find("#preplanId").textbox("getValue");
